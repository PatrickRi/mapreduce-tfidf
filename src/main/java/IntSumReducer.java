...
public class IntSumReducer extends Reducer<Text, DocIdFreq, Text, HashSet<DocIdFreq>> {
    ...
    public void reduce(Text term, Iterable<DocIdFreq> values, Context context) throws IOException, InterruptedException {
        System.out.println("CUSTOM IN R2");
//            log.warning("ERR Counter=" + documentCounter);
        ...
        HashSet<DocIdFreq> resultSet = new HashSet<DocIdFreq>();
        int f_t = 0;
